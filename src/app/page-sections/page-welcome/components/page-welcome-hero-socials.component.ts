  ...
  template: `
    <div class="flex items-center gap-3">
      ...
      <a
        ...
        aria-label="LinkedIn"
        class="group flex h-11 w-11 items-center justify-center rounded-full border border-line text-sage transition-colors hover:border-signal/60 hover:text-signal">
      ...
      <a
        ...
        aria-label="GitHub"
        class="group flex h-11 w-11 items-center justify-center rounded-full border border-line text-sage transition-colors hover:border-signal/60 hover:text-signal">
        <svg viewBox="0 0 32 32" class="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <a
        ...
        class="group flex h-11 w-11 items-center justify-center rounded-full border border-line text-sage transition-colors hover:border-signal/60 hover:text-signal">
        <svg viewBox="-7 0 32 32" class="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path
