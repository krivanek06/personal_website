  ...
  template: `
    <div class="flex items-center gap-10">
      ...
      <a #social [href]="URL_LINKED_IN" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="0 0 24 24"
          class="h-14 w-14 cursor-pointer fill-gray-300 transition-all duration-700 hover:fill-green-500"
      ...
      <a #social [href]="URL_INSTAGRAM" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="-7 0 32 32"
          class="h-[88px] w-[88px] cursor-pointer fill-gray-300 transition-all duration-700 hover:fill-green-500"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg">
