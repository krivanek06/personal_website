...
import { URL_GITHUB, URL_INSTAGRAM, URL_LINKED_IN } from '../model';

@Component({
  selector: 'app-page-welcome-hero-socials',
  imports: [],
  template: `
    <div class="flex items-center gap-6 sm:gap-10">
      <!-- linked in -->
      <a #social [href]="URL_LINKED_IN" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="0 0 24 24"
          class="h-12 w-12 cursor-pointer fill-gray-300 transition-all duration-700 hover:fill-green-500 lg:h-14 lg:w-14"
      ...
      <!-- instagram -->
      <a #social [href]="URL_INSTAGRAM" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="-7 0 32 32"
          class="h-[76px] w-[76px] cursor-pointer fill-gray-300 transition-all duration-700 hover:fill-green-500 lg:h-[88px] lg:w-[88px]"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg">
...
export class PageWelcomeHeroSocialsComponent {
  readonly URL_LINKED_IN = URL_LINKED_IN;
  readonly URL_GITHUB = URL_GITHUB;
  readonly URL_INSTAGRAM = URL_INSTAGRAM;

  readonly socials = viewChildren<ElementRef<HTMLElement>>('social');
}
