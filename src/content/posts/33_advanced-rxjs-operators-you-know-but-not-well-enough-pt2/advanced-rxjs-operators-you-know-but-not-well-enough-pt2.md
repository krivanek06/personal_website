...
![RxJS debounceTime() and auditTime() visual difference](auditTime-vs-debounceTime.gif)
...
![RxJS race operator visual description](race.png)
...
![RxJS iif() operator with Promises](iif-without-defer.gif)
...
![RxJS iif() operator with Promises using defer](iif-with-defer.gif)
